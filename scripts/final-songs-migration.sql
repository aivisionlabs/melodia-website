...
-- Total songs: 26
-- Timestamp: 2025-10-04T12:23:31.590Z
-- Schema-compliant migration
...
Recommended Voice Style: A male vocalist with a confident, energetic, and slightly swaggering tone would be perfect. The delivery should be clear but playful, somewhere between singing and rhythmic talking, much like contemporary Indian pop artists.',
    ...
    SELECT
        ...
        '{"original_id":1,"original_sequence":1,"duration":"179.00","song_url":"/audio/ruchi-my-queen.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.596Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Rap'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":2,"original_sequence":2,"duration":"189.00","song_url":"/audio/kaleidoscope.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.596Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Romantic Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":3,"original_sequence":3,"duration":"195.00","song_url":"/audio/office-love.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.596Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Love Story'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":4,"original_sequence":4,"duration":"181.00","song_url":"/audio/kids-musical.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Musical'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":5,"original_sequence":5,"duration":"181.00","song_url":"/audio/birthday-queen.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Birthday Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":6,"original_sequence":6,"duration":"113.00","song_url":"/audio/nirvan-birthday.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":7,"original_sequence":7,"duration":"180.00","song_url":"/audio/wedding-anthem.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Wedding Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":8,"original_sequence":8,"duration":"180.00","song_url":"/audio/unchained.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":9,"original_sequence":9,"duration":"150.00","song_url":"/audio/blue-party.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":10,"original_sequence":10,"duration":"200.00","song_url":"/audio/sweet-dreams-tonight.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Lullaby'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":11,"original_sequence":11,"duration":"181.00","song_url":"/audio/akash-birthday.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Birthday Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":12,"original_sequence":12,"duration":"197.00","song_url":"/audio/yaara.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Romantic Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":13,"original_sequence":13,"duration":"269.00","song_url":"/audio/har-lamha-naya.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Love Song'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":14,"original_sequence":14,"duration":"174.00","song_url":"/audio/jashn-e-hemali.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":15,"original_sequence":15,"duration":"174.00","song_url":"/audio/jassi-di-jaan.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":16,"original_sequence":16,"duration":"274.00","song_url":"/audio/a-dream-named-jivy.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":null}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Parent''s Love'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":20,"original_sequence":17,"duration":"250.24","song_url":"https://apiboxfiles.erweima.ai/ZjdmMmE0N2ItMDFiNy00MGExLWE5ZjEtNDE4OTg3MTY1Y2Vk.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.597Z","suno_task_id":"f1b68a11b68468d163ea25449ed28de8"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Rakshabandhan'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":21,"original_sequence":18,"duration":"154.08","song_url":"https://apiboxfiles.erweima.ai/ODQ5Mzg5NGUtYWRjNC00NTg3LTlmNGEtMzMwMTMyYmZkZjNi.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"7978ee8e970d11c33398b5f951c0385d"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Lullaby'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":23,"original_sequence":19,"duration":"207.64","song_url":"https://apiboxfiles.erweima.ai/NzViNmFhM2QtYjRiOS00MzRhLTk1OGYtYmMzYWEzMWY2MmY2.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"cf5f2aeceeaad2967121a7ebefc9b18d"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Mother''s Love'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":24,"original_sequence":20,"duration":"154.40","song_url":"https://apiboxfiles.erweima.ai/ODMyNWFiNDAtYTQ1Ny00NDQ3LWFmYWEtMzk4ZGM0NzdhMzY3.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"961574c339365b8fd793bce7ff58d15c"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Dance Musical'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":25,"original_sequence":21,"duration":"239.76","song_url":"https://apiboxfiles.erweima.ai/NGFiMjA3ZmUtNTM3Yy00Y2QzLWI5YzgtMDg2ZjgzNjkxYTdi.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"cfb59a2717a0b1ad79f1b5766503f5f0"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Parents Love'],
        ARRAY['love'],
    ...
    SELECT
        ...
        '{"original_id":26,"original_sequence":null,"duration":"213.12","song_url":"https://cdn1.suno.ai/714c76a4-5685-48fc-b4ed-11c4d8d64d26.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"fd53e16633dc0b36940737886d43b052"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Birthday Party'],
        ARRAY[]::text[],
    ...
    SELECT
        ...
        '{"original_id":27,"original_sequence":null,"duration":"169.48","song_url":"https://cdn1.suno.ai/30a6ddca-b173-48eb-8dcf-5ede2c72729a.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"741b7e046ce76cca584b1d564eacf297"}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":28,"original_sequence":null,"duration":"152.44","song_url":"https://cdn1.suno.ai/bdf8f5e8-9c96-483a-ac01-0b64461a96e5.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"ddc0f02bc7b1d7d1b1fa89398d80898c"}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":31,"original_sequence":null,"duration":"181.88","song_url":"https://cdn1.suno.ai/78df5b9b-6168-4524-81c0-969adee3073a.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"325472ae8dd1c9a05df09c6d4dae45e9"}'::jsonb,
        ld.id,
        'Melodia',
    ...
    SELECT
        ...
        '{"original_id":34,"original_sequence":null,"duration":"185.16","song_url":"https://cdn1.suno.ai/7640609c-d9ea-4ca2-aab9-8dfe9cd314a9.mp3","has_timestamped_lyrics":true,"migration_date":"2025-10-04T12:23:31.598Z","suno_task_id":"3433e364182372bbad962effa42f0fd9"}'::jsonb,
        ld.id,
        'Melodia',
        ARRAY['Party','Friendship'],
