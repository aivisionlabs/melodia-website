...
export default function CreateLyricsPage({
  ...
  const handleRefine = async (refineText: string) => {
    ...
    const currentLyrics =
      currentDraft.edited_text || currentDraft.generated_text;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 overflow-hidden sticky top-8">
                ...
                <div className="p-8">
                  {songRequest &&
                  songRequest.languages &&
                  songRequest.languages.length > 0 ? (
                    <LyricsControls
                    ...
                    <div className="p-4 bg-red-50 border border-red-200 rounded text-sm">
                      <p className="text-red-800">
                        No languages found in song request. Using default:
                        English
                      </p>
                      <LyricsControls
