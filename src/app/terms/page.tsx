        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-800 rounded-lg shadow-lg p-8 prose prose-lg max-w-none border border-slate-700">
            ...
            <p className="text-gray-300 mb-6">
              By accessing and using Melodia (&quot;the Service&quot;), you
            ...
            <p className="text-gray-300 mb-6">
              ...
              based on user input. Our service includes:
            </p>
            ...
            <p className="text-gray-300 mb-4">
              You retain ownership of any content you provide to us, including
              song requests, personal information, and custom lyrics. By using
              our service, you grant us a license to use this content to provide
              our services.
            </p>
            ...
            <p className="text-gray-300 mb-4">
              Songs generated by our AI are created based on your input and
              preferences. You have the right to use these songs for personal
              purposes. However, commercial use may be subject to additional
              terms and licensing requirements.
            </p>
            ...
            <p className="text-gray-300 mb-6">
              The Melodia platform, including its design, functionality, and
            ...
            <p className="text-gray-300 mb-4">
              Our service may include paid features. By subscribing to paid
            ...
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
              <li>
                Creating content that is illegal, harmful, or violates any laws
              </li>
              <li>
                Generating songs with offensive, defamatory, or inappropriate
                content
              </li>
              ...
              <li>
                Creating content that promotes violence, discrimination, or hate
                speech
              </li>
            </ul>
            ...
            <p className="text-gray-300 mb-6">
              ...
              cannot guarantee uninterrupted access. We may temporarily suspend
              or modify our service for maintenance, updates, or other reasons.
            ...
            <p className="text-gray-300 mb-4">
              ...
              at any time, with or without cause, with or without notice. Upon
              termination:
            </p>
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-300">
                <strong>Email:</strong> legal@melodia.com
                <br />
            ...
            <div className="mt-8 p-4 bg-yellow-50 border-l-4 border-yellow-400">
              <p className="text-yellow-800">
                <strong>Note:</strong> This is a template Terms and Conditions
                page. Please consult with a legal professional to ensure
                compliance with applicable laws and regulations in your
                jurisdiction.
              </p>
            </div>
          </div>
