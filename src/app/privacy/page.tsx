        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-slate-800 rounded-lg shadow-lg p-8 prose prose-lg max-w-none border border-slate-700">
            ...
            <p className="text-gray-300 mb-6">
              At Melodia, we are committed to protecting your privacy and
              ensuring the security of your personal information. This Privacy
              Policy explains how we collect, use, disclose, and safeguard your
              information when you use our AI-powered song creation platform.
            </p>
            ...
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
              ...
              <li>
                <strong>Song Requests:</strong> Recipient names, relationships,
                occasions, and personal details you provide
              </li>
              <li>
                <strong>Custom Content:</strong> Lyrics, messages, and other
            ...
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
              ...
              <li>
                <strong>Cookies and Tracking:</strong> Information stored in
            ...
            <ul className="list-disc list-inside text-gray-300 mb-6 space-y-2">
              <li>
                <strong>Service Provision:</strong> To create personalized songs
                and provide our core services
              </li>
              <li>
            ...
            <p className="text-gray-300 mb-6">
              ...
              policy. Account information is retained while your account is
              active and for a reasonable period after closure. Generated songs
              may be retained longer for service continuity and legal
              compliance.
            </p>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-300">
                <strong>Email:</strong> privacy@melodia.com
                <br />
            ...
            <div className="mt-8 p-4 bg-blue-50 border-l-4 border-blue-400">
              <p className="text-blue-800">
                ...
                with major privacy regulations including GDPR, CCPA, and other
                applicable laws. For specific legal advice, please consult with
