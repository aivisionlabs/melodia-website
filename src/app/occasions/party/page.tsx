...
export const metadata: Metadata = {
  title: "Party Songs | Personalized Music for Your Celebration",
  ...
  keywords: "party songs, personalized party songs, custom party music, celebration songs, festive songs, party playlist, party entertainment, party DJ songs",
  openGraph: {
    title: "Party Songs | Personalized Music for Your Celebration | Melodia",
    description: "Get the party started with custom songs that capture the energy and excitement of your celebration. Perfect for house parties, celebrations, or any festive occasion.",
    ...
    images: [
      {
        ...
        width: 792,
        height: 446,
        alt: "Party Songs | Personalized Music for Your Celebration by Melodia",
      },
    ],
  },
  twitter: {
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Get the party started with custom songs that capture the energy and excitement of your celebration.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Party Song" />
          </div>
