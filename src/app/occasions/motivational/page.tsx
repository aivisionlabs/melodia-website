...
export const metadata: Metadata = {
  title: "Motivational Songs | Personalized Music for Inspiration",
  description: "Boost motivation and inspire greatness with custom songs that energize, encourage, and drive success. Perfect for personal goals, fitness journeys, or life challenges.",
  keywords: "motivational songs, personalized motivational songs, inspiration songs, encouragement songs, success songs, goal songs, fitness songs, life motivation songs",
  openGraph: {
    title: "Motivational Songs | Personalized Music for Inspiration | Melodia",
    description: "Boost motivation and inspire greatness with custom songs that energize, encourage, and drive success. Perfect for personal goals, fitness journeys, or life challenges.",
    url: "https://melodia-songs.com/occasions/motivational",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Motivational Songs | Personalized Music for Inspiration by Melodia",
      },
    ],
  },
  twitter: {
...
export default function umotivationalPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Motivational Songs",
    description: "Boost motivation and inspire greatness with custom songs that energize, encourage, and drive success. Perfect for personal goals, fitness journeys, or life challenges.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Motivational Songs,
            </span>
            <br />
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Boost motivation and inspire greatness with a custom song that energizes, encourages, and drives success.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Motivational Song" />
          </div>
