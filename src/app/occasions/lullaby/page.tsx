...
export const metadata: Metadata = {
  title: "Lullaby Songs | Personalized Music for Peaceful Sleep",
  description: "Create soothing personalized lullabies that help babies and children drift off to sleep. Custom songs filled with love, comfort, and peaceful melodies.",
  keywords: "lullaby songs, personalized lullaby songs, custom lullaby music, baby lullaby songs, children lullaby songs, sleep songs, bedtime songs, peaceful songs",
  openGraph: {
    title: "Lullaby Songs | Personalized Music for Peaceful Sleep | Melodia",
    description: "Create soothing personalized lullabies that help babies and children drift off to sleep. Custom songs filled with love, comfort, and peaceful melodies.",
    url: "https://melodia-songs.com/occasions/lullaby",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Lullaby Songs | Personalized Music for Peaceful Sleep by Melodia",
      },
    ],
  },
  twitter: {
...
export default function ulullabyPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Lullaby Songs",
    description: "Create soothing personalized lullabies that help babies and children drift off to sleep. Custom songs filled with love, comfort, and peaceful melodies.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Create soothing personalized lullabies that help babies and children drift off to sleep with love and comfort.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Lullaby Song" />
          </div>
