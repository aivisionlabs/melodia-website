...
export const metadata: Metadata = {
  title: "Devotional Songs | Personalized Spiritual Music",
  description: "Create meaningful devotional songs that connect with faith, spirituality, and divine love. Custom songs for worship, meditation, or spiritual celebration.",
  keywords: "devotional songs, personalized devotional songs, spiritual songs, worship songs, faith songs, religious songs, meditation songs, spiritual music",
  openGraph: {
    title: "Devotional Songs | Personalized Spiritual Music | Melodia",
    description: "Create meaningful devotional songs that connect with faith, spirituality, and divine love. Custom songs for worship, meditation, or spiritual celebration.",
    url: "https://melodia-songs.com/occasions/devotional-spiritual",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Devotional Songs | Personalized Spiritual Music by Melodia",
      },
    ],
  },
  twitter: {
...
export default function udevotionalspiritualPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Devotional Songs",
    description: "Create meaningful devotional songs that connect with faith, spirituality, and divine love. Custom songs for worship, meditation, or spiritual celebration.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Devotional Songs,
            </span>
            <br />
          ...
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Devotional Song" />
          </div>
