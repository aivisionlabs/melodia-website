...
export const metadata: Metadata = {
  title: "Friendship Songs | Personalized Music Celebrating Your Bond",
  description:
    "Celebrate your friendship with a custom song that captures your shared memories, inside jokes, and the unique bond you share. Perfect for best friends, college buddies, or lifelong companions.",
  keywords:
    "friendship songs, personalized friendship songs, best friend songs, friend songs, buddy songs, pal songs, companion songs, friendship celebration songs, friendship tribute songs",
  openGraph: {
    title:
      "Friendship Songs | Personalized Music Celebrating Your Bond | Melodia",
    description:
      "Celebrate your friendship with a custom song that captures your shared memories, inside jokes, and the unique bond you share. Perfect for best friends, college buddies, or lifelong companions.",
    ...
    images: [
      {
        ...
        width: 792,
        height: 446,
        alt: "Friendship Songs | Personalized Music Celebrating Your Bond by Melodia",
      },
    ],
  },
  twitter: {
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Friendship Songs,
            </span>
            <br />
            <span
          ...
          >
            Celebrate your friendship with a custom song that captures your
            shared memories and the unique bond you share.
          </p>
          <div
            className="mt-6 sm:mt-8 animate-fade-in"
            style={{ animationDelay: "0.6s" }}
          >
            <ShareRequirementsCTA size="lg" text="Create Friendship Song" />
          </div>
