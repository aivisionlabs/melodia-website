...
export const metadata: Metadata = {
  title: "Anniversary Songs | Personalized Music for Your Milestone",
  description:
    "Celebrate your love story with a custom anniversary song that captures your journey together. Perfect for wedding anniversaries, dating anniversaries, or any special milestone.",
  keywords:
    "anniversary songs, personalized anniversary songs, wedding anniversary songs, dating anniversary songs, relationship anniversary songs, love anniversary songs, marriage anniversary songs",
  openGraph: {
    title:
      "Anniversary Songs | Personalized Music for Your Milestone | Melodia",
    description:
      "Celebrate your love story with a custom anniversary song that captures your journey together. Perfect for wedding anniversaries, dating anniversaries, or any special milestone.",
    ...
    images: [
      {
        ...
        width: 792,
        height: 446,
        alt: "Anniversary Songs | Personalized Music for Your Milestone by Melodia",
      },
    ],
  },
  twitter: {
...
export default function uanniversaryPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Anniversary Songs",
    description: "Celebrate your love story with a custom anniversary song that captures your journey together. Perfect for wedding anniversaries, dating anniversaries, or any special milestone.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Anniversary Songs,
            </span>
            <br />
            <span
          ...
          >
            Celebrate your love story with a custom song that captures your
            journey together and honors your special milestone.
          </p>
          <div
            className="mt-6 sm:mt-8 animate-fade-in"
            style={{ animationDelay: "0.6s" }}
          >
            <ShareRequirementsCTA size="lg" text="Create Anniversary Song" />
          </div>
