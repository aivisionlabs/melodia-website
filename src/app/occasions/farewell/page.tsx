...
export const metadata: Metadata = {
  title: "Farewell Songs | Personalized Music for Goodbyes",
  description: "Say goodbye in style with a custom farewell song that honors the memories and celebrates the journey. Perfect for retirement parties, moving away, or life transitions.",
  keywords: "farewell songs, personalized farewell songs, goodbye songs, retirement songs, moving away songs, life transition songs, goodbye party songs",
  openGraph: {
    title: "Farewell Songs | Personalized Music for Goodbyes | Melodia",
    description: "Say goodbye in style with a custom farewell song that honors the memories and celebrates the journey. Perfect for retirement parties, moving away, or life transitions.",
    url: "https://melodia-songs.com/occasions/farewell",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Farewell Songs | Personalized Music for Goodbyes by Melodia",
      },
    ],
  },
  twitter: {
...
export default function ufarewellPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Farewell Songs",
    description: "Say goodbye in style with a custom farewell song that honors the memories and celebrates the journey. Perfect for retirement parties, moving away, or life transitions.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Say goodbye in style with a custom song that honors the memories and celebrates the journey.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Farewell Song" />
          </div>
