...
export const metadata: Metadata = {
  title: "Custom Birthday Songs | Personalized Music for Birthday Celebrations",
  description:
    "Create the perfect personalized birthday song that captures their unique personality and celebrates their special day. Turn birthday memories into beautiful music.",
  keywords:
    "birthday songs, personalized birthday songs, custom birthday music, birthday gift songs, birthday celebration songs, birthday party songs, birthday surprise songs, birthday tribute songs, birthday anthem, birthday playlist",
  openGraph: {
    title:
      "Custom Birthday Songs | Personalized Music for Birthday Celebrations | Melodia",
    description:
      "Create the perfect personalized birthday song that captures their unique personality and celebrates their special day.",
    ...
    images: [
      {
        ...
        width: 792,
        height: 446,
        alt: "Custom Birthday Songs by Melodia",
      },
    ],
  },
  twitter: {
...
export default function BirthdayPage() {
  const structuredData = {
    ...
    "@type": "Service",
    name: "Personalized Birthday Songs",
    description: "Create the perfect personalized birthday song that captures their unique personality and celebrates their special day. Turn birthday memories into beautiful music.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-cream via-primary-yellow/5 to-accent-coral/5 flex flex-col overflow-x-hidden relative">
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          >
            Make their birthday truly special with a custom song that tells
            their unique story and celebrates their journey.
          </p>
          <div
            className="mt-6 sm:mt-8 animate-fade-in"
            style={{ animationDelay: "0.6s" }}
          >
            <ShareRequirementsCTA size="lg" text="Create Birthday Song" />
          </div>
