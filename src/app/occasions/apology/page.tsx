...
export const metadata: Metadata = {
  title: "Apology Songs | Personalized Music for Making Amends",
  description: "Express your sincere apologies through music with a custom song that conveys your heartfelt regret and desire to make things right.",
  keywords: "apology songs, personalized apology songs, custom apology music, sorry songs, forgiveness songs, making amends songs, reconciliation songs",
  openGraph: {
    title: "Apology Songs | Personalized Music for Making Amends | Melodia",
    description: "Express your sincere apologies through music with a custom song that conveys your heartfelt regret and desire to make things right.",
    url: "https://melodia-songs.com/occasions/apology",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Apology Songs | Personalized Music for Making Amends by Melodia",
      },
    ],
  },
  twitter: {
...
export default function uapologyPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Apology Songs",
    description: "Express your sincere apologies through music with a custom song that conveys your heartfelt regret and desire to make things right.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Express your sincere apologies through music with a custom song that conveys your heartfelt regret and desire to make things right.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Apology Song" />
          </div>
