...
export default function uweddingsPage() {
  const structuredData = {
    ...
    "@type": "Service",
    name: "Personalized Wedding Songs",
    description: "Create the perfect personalized wedding song for your ceremony, reception, or special moments. From romantic ballads to celebration anthems, make your wedding unforgettable.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
