...
export const metadata: Metadata = {
  title: "Corporate Event Songs | Personalized Music for Business Celebrations",
  description: "Elevate your corporate events with custom songs that celebrate achievements, milestones, and team spirit. Perfect for company parties, product launches, or corporate celebrations.",
  keywords: "corporate event songs, personalized corporate songs, business celebration songs, company party songs, corporate entertainment, business milestone songs",
  openGraph: {
    title: "Corporate Event Songs | Personalized Music for Business Celebrations | Melodia",
    description: "Elevate your corporate events with custom songs that celebrate achievements, milestones, and team spirit. Perfect for company parties, product launches, or corporate celebrations.",
    url: "https://melodia-songs.com/occasions/corporate-events",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Corporate Event Songs | Personalized Music for Business Celebrations by Melodia",
      },
    ],
  },
  twitter: {
...
export default function ucorporateeventsPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Corporate Event Songs",
    description: "Elevate your corporate events with custom songs that celebrate achievements, milestones, and team spirit. Perfect for company parties, product launches, or corporate celebrations.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Corporate Event Songs,
            </span>
            <br />
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Elevate your corporate events with custom songs that celebrate achievements, milestones, and team spirit.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Corporate Song" />
          </div>
