...
export const metadata: Metadata = {
  title: "Festive Holiday Songs | Personalized Music for Celebrations",
  description: "Celebrate holidays and festivals with custom songs that capture the joy and spirit of special occasions. Perfect for Christmas, Diwali, Eid, or any festive celebration.",
  keywords: "festive songs, holiday songs, personalized holiday songs, Christmas songs, Diwali songs, Eid songs, festival songs, celebration songs, holiday music",
  openGraph: {
    title: "Festive Holiday Songs | Personalized Music for Celebrations | Melodia",
    description: "Celebrate holidays and festivals with custom songs that capture the joy and spirit of special occasions. Perfect for Christmas, Diwali, Eid, or any festive celebration.",
    url: "https://melodia-songs.com/occasions/festive-holiday",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Festive Holiday Songs | Personalized Music for Celebrations by Melodia",
      },
    ],
  },
  twitter: {
...
export default function ufestiveholidayPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Festive Holiday Songs",
    description: "Celebrate holidays and festivals with custom songs that capture the joy and spirit of special occasions. Perfect for Christmas, Diwali, Eid, or any festive celebration.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
        ...
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          <h1 className="text-3xl mt-4 sm:text-4xl md:text-5xl font-bold text-text-teal font-heading max-w-3xl mx-auto leading-tight">
            <span className="bg-gradient-to-r from-text-teal via-accent-coral to-text-teal bg-clip-text text-transparent animate-fade-in">
              Unforgettable Festive Holiday Songs,
            </span>
            <br />
          ...
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Holiday Song" />
          </div>
