...
export const metadata: Metadata = {
  title: "Romantic Songs | Personalized Love Songs for Your Special Someone",
  description:
    "Express your deepest feelings with a custom romantic song that captures your love story. Perfect for proposals, Valentine's Day, or any romantic moment.",
  keywords:
    "romantic songs, personalized romantic songs, love songs, custom love songs, romantic music, love music, romantic ballads, love ballads, proposal songs",
  openGraph: {
    title:
      "Romantic Songs | Personalized Love Songs for Your Special Someone | Melodia",
    description:
      "Express your deepest feelings with a custom romantic song that captures your love story. Perfect for proposals, Valentine's Day, or any romantic moment.",
    url: "https://melodia-songs.com/occasions/romantic",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Romantic Songs | Personalized Love Songs for Your Special Someone by Melodia",
      },
    ],
  },
  twitter: {
...
export default function uromanticPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Romantic Songs",
    description: "Express your deepest feelings with a custom romantic song that captures your love story. Perfect for proposals, Valentine's Day, or any romantic moment.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-cream via-primary-yellow/5 to-accent-coral/5 flex flex-col overflow-x-hidden relative">
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          >
            Express your deepest feelings with a custom song that captures your
            unique love story and romantic moments.
          </p>
          <div
            className="mt-6 sm:mt-8 animate-fade-in"
            style={{ animationDelay: "0.6s" }}
          >
            <ShareRequirementsCTA size="lg" text="Create Romantic Song" />
          </div>
