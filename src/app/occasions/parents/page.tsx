...
export const metadata: Metadata = {
  title: "Parent Songs | Personalized Music Honoring Mom and Dad",
  description: "Honor your parents with custom songs that celebrate their love, sacrifice, and guidance. Perfect for Mother's Day, Father's Day, or any occasion to show appreciation.",
  keywords: "parent songs, personalized parent songs, mom songs, dad songs, mother songs, father songs, parent tribute songs, family songs, parent appreciation songs",
  openGraph: {
    title: "Parent Songs | Personalized Music Honoring Mom and Dad | Melodia",
    description: "Honor your parents with custom songs that celebrate their love, sacrifice, and guidance. Perfect for Mother's Day, Father's Day, or any occasion to show appreciation.",
    url: "https://melodia-songs.com/occasions/parents",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Parent Songs | Personalized Music Honoring Mom and Dad by Melodia",
      },
    ],
  },
  twitter: {
...
export default function uparentsPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Parent Songs",
    description: "Honor your parents with custom songs that celebrate their love, sacrifice, and guidance. Perfect for Mother's Day, Father's Day, or any occasion to show appreciation.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Honor your parents with a custom song that celebrates their love, sacrifice, and guidance.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Parent Song" />
          </div>
