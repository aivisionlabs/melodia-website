...
export default function usiblingsPage() {
  const structuredData = {
    ...
    "@type": "Service",
    name: "Personalized Sibling Songs",
    description: "Celebrate the special bond between siblings with custom songs that capture shared memories, childhood adventures, and the unique connection only siblings understand.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
