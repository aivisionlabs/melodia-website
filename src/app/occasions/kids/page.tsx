...
export const metadata: Metadata = {
  title: "Kids Songs | Personalized Music for Children",
  description: "Create magical personalized songs for kids that spark their imagination and celebrate their unique personality. Perfect for birthdays, achievements, or just because.",
  keywords: "kids songs, personalized kids songs, children songs, custom kids music, kids birthday songs, kids celebration songs, kids achievement songs, kids lullaby songs",
  openGraph: {
    title: "Kids Songs | Personalized Music for Children | Melodia",
    description: "Create magical personalized songs for kids that spark their imagination and celebrate their unique personality. Perfect for birthdays, achievements, or just because.",
    url: "https://melodia-songs.com/occasions/kids",
    images: [
      {
        url: "/images/melodia-logo-og.jpeg",
        width: 792,
        height: 446,
        alt: "Kids Songs | Personalized Music for Children by Melodia",
      },
    ],
  },
  twitter: {
...
export default function ukidsPage() {
  const structuredData = {
    "@context": "https://schema.org",
    "@type": "Service",
    name: "Personalized Kids Songs",
    description: "Create magical personalized songs for kids that spark their imagination and celebrate their unique personality. Perfect for birthdays, achievements, or just because.",
    provider: {
      "@type": "Organization",
      name: "Melodia",
      ...
      <main className="flex-1 relative z-10">
        <section className="w-full bg-gradient-to-br from-primary-yellow/20 via-transparent to-accent-coral/10 text-center pt-12 sm:pt-16 md:pt-20 pb-20 sm:pb-24 md:pb-32 px-4 relative overflow-hidden">
          ...
          <p className="text-text-teal/80 mt-3 sm:mt-4 text-base sm:text-lg max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: "0.4s" }}>
            Create magical songs for kids that spark their imagination and celebrate their unique personality and achievements.
          </p>
          <div className="mt-6 sm:mt-8 animate-fade-in" style={{ animationDelay: "0.6s" }}>
            <ShareRequirementsCTA size="lg" text="Create Kids Song" />
          </div>
